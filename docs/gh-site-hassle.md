...
Now I broke GitHub. The build (https://github.com/aeconoclast/aeconoclast.github.io/actions/runs/20586136002) failed with this message:
...
Next Step
---
Add links to the blue part of the banner. These are part of the *section id=downloads*
